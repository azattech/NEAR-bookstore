...
Each account on NEAR can have at most one contract deployed to it. If you've already created an account such as `your-name.testnet`, you can deploy your contract to `bookstore.your-name.testnet`. Assuming you've already created an account on [NEAR Wallet], here's how to create `bookstore.your-name.testnet`:
...
2. Create a subaccount (replace `YOUR-NAME` below with your actual account name):
   ...
   near create-account bookstore.YOUR-NAME.testnet --masterAccount YOUR-NAME.testnet
...
"price" : “4000000000000000000000000”
    ...
    near call $CONTRACT_NAME buyBook '{ "bookId: 1, "price", "2000000000000000000000000"}' --accountId <accountID> --deposit 2
